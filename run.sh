...
#  --val_av_rank_max_qs 1000 \
#  --model_file /home/chy/GC-DPR-main/0.453/macbert_model_ckp/dpr_biencoder.4.85 \
#  --fp16
...
#python dense_retriever.py \
#   --dureader_test \
#   --model_file ./0.566/macbert_model_ckp/dpr_biencoder.4.85 \
#   --ctx_file  ./data/dureader_data/passages.tsv \
