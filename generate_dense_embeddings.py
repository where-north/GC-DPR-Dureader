...
def main(args):
    ...
    logger.info(f'Producing encodings for {len(rows)} passages')

    data = gen_ctx_vectors(rows, encoder, tensorizer, False, fp16=args.fp16)  # insert_title=False
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch_size', type=int, default=128, help="Batch size for the passage encoder forward pass")
